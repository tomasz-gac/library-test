...
public class TierTest {
	...
	public void theLoanLimitComesFromTheMembersTier() {
		Library lib = stocked()
				.checkOut(500, 1, 100, 10).get()
				.checkOut(501, 2, 101, 10).get();
		assertThat(lib.checkOutDenials(100, 3)).containsExactlyInAnyOrder("at loan limit");
		assertThat(lib.checkOut(502, 3, 101, 10).isSuccess()).isTrue();
	}
	...
	public void theDueDayComesFromTheMembersTier() {
		...
		assertThat(lib.overdueLoans(17)).isEmpty();
		assertThat(lib.overdueLoans(18)).containsExactlyInAnyOrder(500);
		assertThat(lib.overdueLoans(41)).containsExactlyInAnyOrder(500, 501);
	}
	...
	public void aMemberWhoseTierHasNoPolicyIsDeniedByName() {
		...
		assertThat(lib.checkOut(500, 1, 102, 10).isFailure()).isTrue();
	}
